...
contract LinearRateTest is VariableInterestRate, BasePairTest {
    ...
    function _testLinearInitData(bytes memory _initData) public {
        ...
        // halfway between vertex and 0 utilization, expects half of the rate between vertex and
        // mininimum interest
        assertApproxEqRel(
    ...
    function _getNewRate(uint256 _utilization, bytes memory _initData)
        public
        view
        returns (uint256 _newRate)
    {
